...
由 `update_prices.py` 于 2026-09-24T03:58:29 自动生成。

| 数据 Provider | 网页 | 抓取地址 | 许可 | 状态 | 记录数 |
| --- | --- | --- | --- | --- | --- |
| 302.AI | https://302.ai/price | `https://price.302.ai/en/pricing_website/` | 公开价格表 | ✅ | 3 |
| Alibaba Model Studio Wan 官方价格（人工核验） | https://help.aliyun.com/en/model-studio/model-pricing | `https://help.aliyun.com/en/model-studio/model-pricing` | 厂商官方价格页（人工核验快照） | ✅ | 6 |
| Anthropic 官方文档 | https://platform.claude.com/docs/en/about-claude/pricing | `https://platform.claude.com/docs/en/about-claude/pricing.md` | 厂商官方文档 | ✅ | 38 |
| AWS Bedrock | https://aws.amazon.com/bedrock/pricing/ | `https://pricing.us-east-1.amazonaws.com/offers/v1.0/aws/AmazonBedrock/` | AWS 公开价格表 | ✅ | 819 |
| AWS Bedrock | https://aws.amazon.com/bedrock/pricing/ | `https://pricing.us-east-1.amazonaws.com/offers/v1.0/aws/AmazonBedrockF` | AWS 公开价格表 | ✅ | 265 |
...
| Bria 官方按张价 | https://bria.ai/pricing | `https://bria.ai/pricing` | 厂商官方价格页 | ✅ | 2 |
...
| DeepInfra | https://deepinfra.com/models | `https://api.deepinfra.com/models/list` | 公开 API | ✅ | 284 |
| DeepInfra | https://deepinfra.com/models | `https://api.deepinfra.com/models/list` | 第三方托管价目 | ✅ | 21 |
| DeepSeek API 官方价格（人工核验） | https://api-docs.deepseek.com/quick_start/pricing/ | `https://api-docs.deepseek.com/quick_start/pricing/` | 厂商官方价格页（人工核验快照） | ✅ | 3 |
| European Central Bank reference rates | https://data.ecb.europa.eu/key-figures/ecb-interest-rates-and-exchange-rates/exchange-rates | `https://www.ecb.europa.eu/stats/eurofxref/eurofxref-daily.xml` | ECB reference rates | ✅ | 170 |
| Empirio Labs | https://empiriolabs.ai | `https://api.empiriolabs.ai/v1/models` | 公开 API | ✅ | 93 |
...
| LiteLLM | https://github.com/BerriAI/litellm | `https://cdn.jsdelivr.net/gh/BerriAI/litellm@main/model_prices_and_cont` | MIT | ✅ | 3374 |
...
| models.dev | https://models.dev | `https://models.dev/api.json` | MIT | ✅ | 6652 |
...
| nano-gpt | https://nano-gpt.com | `https://nano-gpt.com/api/models` | 第三方转售价目 | ✅ | 82 |
| Novita AI | https://novita.ai/models | `https://api.novita.ai/v3/openai/models` | 公开 API | ✅ | 102 |
| ofox | https://ofox.ai | `https://api.ofox.ai/v2/models/catalog?include=provider_price&limit=100` | 公开 API | ✅ | 151 |
| OpenAI 官方文档 | https://platform.openai.com/docs/pricing | `https://developers.openai.com/api/docs/pricing.md` | 厂商官方文档 | ✅ | 246 |
| OpenRouter | https://openrouter.ai/models | `https://openrouter.ai/api/v1/models` | 公开 API | ✅ | 366 |
| OVHcloud AI Endpoints | https://endpoints.ai.cloud.ovh.net | `https://catalog.endpoints.ai.ovh.net/rest/v2/openrouter` | 公开 API | ✅ | 12 |
| Pioneer | https://pioneer.ai | `https://api.pioneer.ai/v1/models` | 公开 API | ✅ | 35 |
...
| Pruna AI 官方按张价（人工核验） | https://www.pruna.ai/pricing | `https://www.pruna.ai/pricing` | 厂商官方价格页（人工核验快照） | ✅ | 2 |
| Requesty | https://requesty.ai | `https://router.requesty.ai/v1/models/managed` | 公开 API | ✅ | 136 |
| Runway API Gemini Omni 公开价格（人工核验） | https://docs.dev.runwayml.com/guides/pricing/ | `https://docs.dev.runwayml.com/guides/pricing/` | 公开第三方 API 价格页 | ✅ | 1 |
| Runway Dev 官方价格（人工核验） | https://docs.dev.runwayml.com/guides/pricing/ | `https://docs.dev.runwayml.com/guides/pricing/` | 厂商官方价格页（人工核验快照） | ✅ | 4 |
| SenseNova 官方模型列表 | https://www.sensecore.cn/help/docs/model-as-a-service/nova/overview/compatible-mode | `https://www.sensecore.cn/help/docs/model-as-a-service/nova/overview/co` | 厂商官方模型文档 | ✅ | 4 |
| SenseNova 官方价格 | https://www.sensecore.cn/help/docs/model-as-a-service/nova/pricing | `https://www.sensecore.cn/help/docs/model-as-a-service/nova/pricing` | 厂商官方价格页 | ✅ | 9 |
| SenseNova Token Plan | https://www.sensenova.cn/token-plan | `https://www.sensenova.cn/token-plan` | 厂商官方套餐页 | ✅ | 2 |
| StepFun 官方价格 | https://platform.stepfun.com/docs/zh/guides/pricing/details | `https://platform.stepfun.com/docs/zh/guides/pricing/details` | 厂商官方价格页 | ✅ | 8 |
| 腾讯 TokenHub 官方价格 | https://cloud.tencent.com/document/product/1823/130055 | `https://cloud.tencent.com/document/product/1823/130055` | 厂商官方价格页 | ✅ | 4 |
| Tinfoil | https://tinfoil.sh | `https://inference.tinfoil.sh/v1/models` | 公开 API | ✅ | 9 |
| Upstage 官方价格 | https://www.upstage.ai/pricing/api | `https://www.upstage.ai/pricing/api` | 厂商官方价格页 | ✅ | 0 |
| Vercel AI Gateway | https://vercel.com/ai-gateway/models | `https://ai-gateway.vercel.sh/v1/models` | 公开 API | ✅ | 383 |
| Vidu API 官方价格（人工核验） | https://platform.vidu.com/docs/pricing | `https://platform.vidu.com/docs/pricing` | 厂商官方价格页（人工核验快照） | ✅ | 9 |
| 火山方舟官方价格（人工核验） | https://www.volcengine.com/product/doubao | `https://www.volcengine.com/product/doubao` | 厂商官方价格页（人工核验快照） | ✅ | 7 |
| xAI 官方文档 | https://docs.x.ai/docs/models | `https://docs.x.ai/developers/models.md` | 厂商官方文档 | ✅ | 21 |
| Zhipu BigModel | https://open.bigmodel.cn/pricing | `https://open.bigmodel.cn/api/biz/operation/query?ids=1122` | 官方定价页 | ✅ | 6 |
| Zhipu AI / GLM 官方文档 | https://docs.z.ai/guides/overview/pricing | `https://docs.z.ai/guides/overview/pricing.md` | 厂商官方文档 | ✅ | 29 |
...
- moonshot_md: 未识别的列头 `cache write price (ttl 1h)`
- moonshot_md: 未识别的列头 `cache write price (ttl 5min)`
- volcengine_official_verified: 价格页无法稳定服务端渲染，当前使用 2026-08-25T00:00:00+10:00 人工核验快照；URL 与原文摘录已保留
- deepseek_official_verified: 价格页无法稳定服务端渲染，当前使用 2026-08-25T00:00:00+10:00 人工核验快照；URL 与原文摘录已保留
- google_omni_video_official_verified: 价格页无法稳定服务端渲染，当前使用 2026-08-29T00:00:00+10:00 人工核验快照；URL 与原文摘录已保留
- fal_google_video_verified: 价格页无法稳定服务端渲染，当前使用 2026-08-29T00:00:00+10:00 人工核验快照；URL 与原文摘录已保留
- runway_google_video_verified: 价格页无法稳定服务端渲染，当前使用 2026-08-29T00:00:00+10:00 人工核验快照；URL 与原文摘录已保留
- google_video_official_verified: 价格页无法稳定服务端渲染，当前使用 2026-08-27T00:00:00+10:00 人工核验快照；URL 与原文摘录已保留
- minimax_video_official_verified: 价格页无法稳定服务端渲染，当前使用 2026-08-27T00:00:00+10:00 人工核验快照；URL 与原文摘录已保留
- runway_video_official_verified: 价格页无法稳定服务端渲染，当前使用 2026-08-27T00:00:00+10:00 人工核验快照；URL 与原文摘录已保留
- luma_video_official_verified: 价格页无法稳定服务端渲染，当前使用 2026-08-27T00:00:00+10:00 人工核验快照；URL 与原文摘录已保留
- vidu_video_official_verified: 价格页无法稳定服务端渲染，当前使用 2026-08-27T00:00:00+10:00 人工核验快照；URL 与原文摘录已保留
- pixverse_video_official_verified: 价格页无法稳定服务端渲染，当前使用 2026-08-27T00:00:00+10:00 人工核验快照；URL 与原文摘录已保留
- alibaba_video_official_verified: 价格页无法稳定服务端渲染，当前使用 2026-08-27T00:00:00+10:00 人工核验快照；URL 与原文摘录已保留

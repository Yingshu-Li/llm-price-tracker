...
由 `update_prices.py` 于 2026-09-01T04:22:23 自动生成。
...
| DeepInfra | https://deepinfra.com/models | `https://api.deepinfra.com/models/list` | 公开 API | ✅ | 275 |
...
| Empirio Labs | https://empiriolabs.ai | `https://api.empiriolabs.ai/v1/models` | 公开 API | ✅ | 74 |
...
| HuggingFace Router | https://huggingface.co/models?inference_provider=all | `https://router.huggingface.co/v1/models` | 公开 API | ✅ | 188 |
...
| LiteLLM | https://github.com/BerriAI/litellm | `https://cdn.jsdelivr.net/gh/BerriAI/litellm@main/model_prices_and_cont` | MIT | ✅ | 2691 |
...
| models.dev | https://models.dev | `https://models.dev/api.json` | MIT | ✅ | 6024 |
...
| nano-gpt | https://nano-gpt.com | `https://nano-gpt.com/api/models` | 第三方转售价目 | ✅ | 65 |
| Novita AI | https://novita.ai/models | `https://api.novita.ai/v3/openai/models` | 公开 API | ✅ | 127 |
| ofox | https://ofox.ai | `https://api.ofox.ai/v2/models/catalog?include=provider_price&limit=100` | 公开 API | ✅ | 138 |
...
| Requesty | https://requesty.ai | `https://router.requesty.ai/v1/models/managed` | 公开 API | ✅ | 117 |

...
由 `update_prices.py` 于 2026-09-08T03:51:09 自动生成。
...
| European Central Bank reference rates | https://data.ecb.europa.eu/key-figures/ecb-interest-rates-and-exchange-rates/exchange-rates | `https://www.ecb.europa.eu/stats/eurofxref/eurofxref-daily.xml` | ECB reference rates | ✅ | 165 |
...
| HuggingFace Router | https://huggingface.co/models?inference_provider=all | `https://router.huggingface.co/v1/models` | 公开 API | ✅ | 195 |
...
| models.dev | https://models.dev | `https://models.dev/api.json` | MIT | ✅ | 6097 |
...
| nano-gpt | https://nano-gpt.com | `https://nano-gpt.com/api/models` | 第三方转售价目 | ✅ | 70 |
...
| OpenRouter | https://openrouter.ai/models | `https://openrouter.ai/api/v1/models` | 公开 API | ✅ | 350 |
...
| Requesty | https://requesty.ai | `https://router.requesty.ai/v1/models/managed` | 公开 API | ✅ | 129 |
